  ...
  return (
    <div className="pl-[5rem] pr-[5rem] pt-[2rem] flex flex-row items-center">
      <div className="flex flex-row items-center basis-1/2">
        <h1 className="text-[2rem] mr-[5rem]">
          <strong>Shortly</strong>
        </h1>
        <ul className="justify-between hidden md:block">
          <li className="inline">
      ...
      <div className="basis-1/2">
        ...
        <div
          className="flex md:hidden basis justify-end cursor-pointer"
        ...
        >
          ...
          <div
            className="mt-[3rem] w-[15rem] p-[1rem] text-center leading-[2.5rem] bg-[#3a3053] cursor-default rounded-xl"
            style={burger}
          >
            <ul>
              <li>
